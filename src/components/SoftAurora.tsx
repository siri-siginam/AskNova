...
export const SoftAurora: React.FC<SoftAuroraProps> = ({
  ...
  useEffect(() => {
    ...
    let renderer: Renderer | null = new Renderer({ alpha: true, premultipliedAlpha: false });
    let gl = renderer.gl;
    ...
    function update(time: number) {
      ...
      program.uniforms.uNoiseFreq.value = noiseFrequency;
      program.uniforms.uNoiseAmp.value = noiseAmplitude;
